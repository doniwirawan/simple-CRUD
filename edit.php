...
<body>
  <div class="row d-flex justify-content-center">
    <div class="col-4 xs-auto justify-content-center border mt-5 p-4 rounded bg-light ">
      ...
      $data = mysqli_query($koneksi, "SELECT * FROM tb_negara_20101108 where kode_20101108='$kode_20101108'");
        ...
        <form action="update.php" method="post" class="mt-4">
          <div class="form-group font-weight-bolder">
            <div class="form-group font-weight-bolder">
              ...
              <input class="form-control" id="formGroupExampleInput2" placeholder="Another input placeholder" name="kode" type="hidden" required value="<?php echo $d['kode_20101108']; ?>">
            </div>
            <label for="formGroupExampleInput">Nama Negara</label>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder" name="nama" required value="<?php echo $d['nama_20101108']; ?>">
          </div>

          <div class="form-group font-weight-bolder">
            <label for="test">Ibukota Negara</label>
            <input class="form-control" id="test" rows="3" name="ibukota" required value="<?php echo $d['ibukota_20101108']; ?>">
          </div>
