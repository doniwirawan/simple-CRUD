...
<body>
  <div class="row d-flex justify-content-center">
    <div class="col-4 xs-auto justify-content-center border mt-5 p-4 rounded bg-light ">
      ...
      <a href="view.php" class="text-decoration-none"><i class="fas fa-backward mr-2"></i>KEMBALI</a>
      ...
      <form action="update.php" method="post" class="mt-4">
        <div class="form-group font-weight-bolder">
          ...
          <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder"
            name="nama" required value="<?php echo $d['nama']; ?>">
        </div>
        <div class="form-group font-weight-bolder">
          ...
          <input type="number" class="form-control" id="formGroupExampleInput2" placeholder="Another input placeholder"
            name="nim" required value="<?php echo $d['nim']; ?>">
        </div>
        <div class="form-group font-weight-bolder">
          <label for="exampleFormControlTextarea1">Alamat</label>
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat" required
            value="<?php echo $d['alamat']; ?>"></textarea>
        </div>
