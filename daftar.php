    ...
    <div class="col-lg-4 col-xs-10 xs-auto justify-content-center border mt-lg-5 p-4 p-xs-5 rounded bg-light ">
      ...
      <form action="input_data.php" method="POST" class="">
        <div class="form-group font-weight-bolder">
          ...
          <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Ex : Doni Wirawan" name="nama" required>
        </div>
        <div class="form-group font-weight-bolder">
          <label for="formGroupExampleInput2">NIM</label>
          <input type="number" class="form-control" id="formGroupExampleInput2" placeholder="Ex : 12345" name="nim" required>
        </div>
        <div class="form-group font-weight-bolder">
